...
This project is a fork of [FearLabsAudio/midi2furnace](https://github.com/FearLabsAudio/midi2furnace) with a complete overhaul of all aspects of the software.
